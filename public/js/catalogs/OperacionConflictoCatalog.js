...
function OperacionConflictoCatalog(cfg, dtCfg) {
...
OperacionConflictoCatalog.prototype = Object.create(Catalog.prototype);

OperacionConflictoCatalog.prototype.edit = function(id) {
    var url = `${base_url}/${id}`,
        fields = [
...
OperacionConflictoCatalog.prototype.destroy = function(id, inactive) {
