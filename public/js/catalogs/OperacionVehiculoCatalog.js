...
function OperacionVehiculoCatalog(cfg, dtCfg) {
...
OperacionVehiculoCatalog.prototype = Object.create(Catalog.prototype);

OperacionVehiculoCatalog.prototype.edit = function(id) {
    var url = `${base_url}/${id}`,
        fields = [
...
OperacionVehiculoCatalog.prototype.destroy = function(id, inactive) {

    Catalog.prototype.destroy.call(this, id, '#tbl_catalogs', inactive);
};


OperacionVehiculoCatalog.prototype.clear = function() {
