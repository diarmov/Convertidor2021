...
Ingresos.prototype.reCalcSubtotal = function () {
    ...
    let otros = $("#otros").val();
    let enajenacion = $("#enajenacion").val();
    ...
    try {
        ...
        let montoEnajenacion = (enajenacion)?parseInt(enajenacion):0;

        montoSubtotal = montoIndustrial + montoFinanciero + montoServicios +montoEnajenacion+ montoOtros;
    } catch(e) {
...
Ingresos.prototype.init_enajenacion = function () {

    recalc(this, 'enajenacion');
};
